...
The number of individuals joining the infected compartment, $b_{i}$, or removed compartment, $c_{i}$ at timestep $i$ can be chosen randomly from a binomial distribution: 
\begin{align*}
