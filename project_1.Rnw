...
tab <- xtable(results_table, digits= c(1, 0, -1, -1, -1, 2, 2, 2), caption = "Values for $\\beta$, the rate of infection, and $\\gamma$, the recovery rate, for the RE inference method  $R_{0}$ of 1.5 or 6 for a population size of 50. PE: point estimate, min: lower bound of 95\\% interval, max: upper bound of 95\\% interval", label = "re_pop50") 
align(tab) <- "lXXXXXXX"
...
tab <- xtable(results_table, digits= c(1, 0, -1, -1, -1, 2, 2, 2), caption = "Values for $\\beta$, the rate of infection, and $\\gamma$, the recovery rate, for the RE inference method  $R_{0}$ of 1.5 or 6 for a population size of 200. PE: point estimate, sim: simulation, min: lower bound of 95\\% interval, max: upper bound of 95\\% interval", label = "re_pop200") 
align(tab) <- "lXXXXXXX"
print(tab, hline.after=c(-1, 0, 12), comment = FALSE, math.style.exponents = FALSE, caption.placement = "top", add.to.row = addtorow, include.colnames = FALSE, type="latex", sanitize.rownames.function = identity, tabular.environment = "tabularx", width = "\\textwidth")
@
...
tab <- xtable(results_table, digits= c(1, 0, -1, -1, -1, 2, 2, 2), caption = "Values for $\\beta$, the per capita rate of infection, and $\\gamma$, the recovery rate, for the RE inference method  $R_{0}$ of 1.5 or 6 for a population size of 1000. PE: point estimate, sim: simulation, min: lower bound of 95\\% interval, max: upper bound of 95\\% interval", label = "re_pop1000") 
align(tab) <- "lXXXXXXX"
print(tab, hline.after=c(-1, 0, 12), comment = FALSE, math.style.exponents = FALSE, caption.placement = "top", add.to.row = addtorow, include.colnames = FALSE, type="latex", sanitize.rownames.function = identity, tabular.environment = "tabularx", width = "\\textwidth")
@
\newline
...
The sum of squared differences between the model and the true recovery curve increased with population size (Table \ref{re_pe}). Additionally, the sum of squared differences for the point estimates tended to be lower for the higher $R_{0}$ than the lower $R_{0}$ for the populations (Table \ref{re_pe}). 
...
\begin{figure}[!h]
\begin{center}
\includegraphics[scale=1.5]{RE_heatmap_pop200}
...
tab <- xtable(results_table, digits= c(1, 0, -1, -1, -1, 2, 2, 2), caption = "$\\beta$ and $\\gamma$ values for the 3.5 million iteration MCMC inference method  $R_{0}$ of 1.5 or 6 for a population size of 50. min: lower bound of 95\\% credible interval, max: upper bound of 95\\% credible interval", label = "mcmc_pop50") 
align(tab) <- "lXXXXXXX"
print(tab, hline.after=c(-1, 0, 12), comment = FALSE, math.style.exponents = FALSE, caption.placement = "top", add.to.row = addtorow, include.colnames = FALSE, type="latex", sanitize.rownames.function = identity, tabular.environment = "tabularx", width = "\\textwidth")
@
\clearpage
...
tab <- xtable(results_table, digits= c(1, 0, -1, -1, -1, 2, 2, 2), caption = "$\\beta$ and $\\gamma$ values for the 3.5 million iteration MCMC inference method  $R_{0}$ of 1.5 or 6 for a population size of 200. min: lower bound of 95\\% credible interval, max: upper bound of 95\\% credible interval", label = "mcmc_pop200") 
align(tab) <- "lXXXXXXX"
print(tab, hline.after=c(-1, 0, 12), comment = FALSE, math.style.exponents = FALSE, caption.placement = "top", add.to.row = addtorow, include.colnames = FALSE, type="latex", sanitize.rownames.function = identity, tabular.environment = "tabularx", width = "\\textwidth")
@
...
tab <- xtable(results_table, digits= c(1, 0, -1, -1, -1, 2, 2, 2), caption = "$\\beta$ and $\\gamma$ values for the 3.5 million iteration MCMC inference method  $R_{0}$ of 1.5 or 6 for a population size of 1000. min: lower bound of 95\\% credible interval, max: upper bound of 95\\% credible interval", label = "mcmc_pop1000") 
align(tab) <- "lXXXXXXX"
print(tab, hline.after=c(-1, 0, 12), comment = FALSE, math.style.exponents = FALSE, caption.placement = "top", add.to.row = addtorow, include.colnames = FALSE, type="latex", sanitize.rownames.function = identity, tabular.environment = "tabularx", width = "\\textwidth")
@
...
beta_yaxis200_1 = c(0, 0.003)
beta_yaxis1000_1 = c(0, 0.0004)
beta_yaxis50_2 = c(0, 0.025)
beta_yaxis200_2 = c(0, 0.007)
beta_yaxis1000_2 = c(0, 0.001)
# Seed 1, Pop size 50
...
plot(mcmc_R1.5_pop1000_seed1$beta, type = "l", main = "", xlab = "", ylab = "", ylim = beta_yaxis1000_1, cex.axis = number_size)
  abline(v = burnIn, untf = FALSE)
text(iteration_place, min(beta_yaxis1000_1)+(0.95*max(beta_yaxis1000_1)-min(beta_yaxis1000_1)), "C", cex = letter_size)
# Seed 1, Pop size 50
...
gamma_yaxis1000_1 = c(0.05, 0.17)
gamma_yaxis50_2 = c(0, 0.30)
gamma_yaxis200_2 = c(0.05, 0.25)
gamma_yaxis1000_2 = c(0.05, 0.15)
...
plot(mcmc_R6_pop1000_seed1$gamma, type = "l", main = "", xlab = "", ylab = "", ylim = gamma_yaxis1000_2, cex.axis=number_size)
  abline(v = burnIn, untf = FALSE)
text(iteration_place, min(gamma_yaxis1000_2)+(0.95*max(gamma_yaxis1000_2)-min(gamma_yaxis1000_2)), "F", cex = letter_size)
mtext("Iteration (x1000)", 1, line = 4, cex = yaxis_size)
@
...
%The range of log-likelihoods is quite varying for different outbreaks within a given $R_{0}$ and population size (Table \ref{mcmc_pop1000}). For instance the mean log-likelihood for population size 50 and $R_{0}$ of 1.5 is -135 for simulation 1 and -1139 for simulation 2 (Table \ref{mcmc_pop1000_long}). This is because the likelihood function was set to return a value of -1000 if the suggested parameters fit the data point with a likelihood of 0, due to the computational difficulties associated with attempting to calculate $log(0)$.
...
tab <- xtable(mcmc_beta_results_table, digits= c(1, 0, -1, -1, -1, 2, 2, 2), caption = "$\\beta$ and $\\gamma$ values for the 17.5 million iteration MCMC inference method  $R_{0}$ of 1.5 or 6 for a population size of 1000. min: lower bound of 95\\% credible interval, max: upper bound of 95\\% credible interval", label = "mcmc_pop1000_long") 
align(tab) <- "lXXXXXXX"
print(tab, hline.after=c(-1, 0, 12), comment = FALSE, math.style.exponents = FALSE, caption.placement = "top", add.to.row = addtorow, include.colnames = FALSE, type="latex", sanitize.rownames.function = identity, tabular.environment = "tabularx", width = "\\textwidth")
@
...
For the 17.5 million iteration run for the largest population size, the MCMC did converge for the outbreak with an $R_{0}$ of 6 and population size of 1000 (Fig. \ref{mcmc_long}D-E). The outbreak with an $R_{0}$ of 1.5 though has not converged (Fig. \ref{mcmc_long}A-B). The infectious curves estimated during the post-burn-in period of the MCMC now do coincide with the true simulated infectious curves (Fig. \ref{mcmc_long}C, F).
\newline
