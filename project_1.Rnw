...
mtext("Time", 1, line = 3, cex = yaxis_size)
@
\caption{Plots showing how the number of susceptible (black), infectious (red), and recovered (orange) individuals changes with time during an outbreak simulated with a stochastic SIR model with an $R_{0}$ of 1.5 and $\gamma$, recovery rate of 0.15. Plots A-E depict a population size of 50, plots F-J depict a population size of 200, and plots K-O depict a population size of 1000.}
\end{center}
\end{figure}
...
mtext("Time", 1, line = 3, cex = yaxis_size)
@
\caption{Plots showing how the number of susceptible (black), infectious (red), and recovered (orange) individuals changes with time during an outbreak simulated with a stochastic SIR model with an $R_{0}$ of 6 and $\gamma$, recovery rate, of 0.15. Plots A-E depict a population size of 50, plots F-J depict a population size of 200, and plots K-O depict a population size of 1000.}
\end{center}
\end{figure}
