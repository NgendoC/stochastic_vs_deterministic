...
run_stoch <- read.csv("data_pop50_R6_g0.15_1.csv")
...
write.csv(data.frame(beta_gamma_loglik), file = "mcmc_pop50_R6_g0.15_1_loglik.csv", row.names = FALSE)

# Infectious curve data
write.csv(data.frame(inf_data2), file = "mcmc_pop50_R6_g0.15_1_infectious.csv", row.names = FALSE)
