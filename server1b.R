...
run_stoch <- read.csv("data_pop1000_R6_g0.15_14.csv")
...
write.csv(data.frame(beta_gamma_loglik), file = "mcmc_pop1000_R6_g0.15_14_loglik_long.csv", row.names = FALSE)

# Infectious curve data
write.csv(data.frame(inf_data2), file = "mcmc_pop1000_R6_g0.15_14_infectious_long.csv", row.names = FALSE)
