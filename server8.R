...
run_stoch <- read.csv("data_pop200_R6_g0.15_10.csv")
...
write.csv(data.frame(beta_gamma_loglik), file = "mcmc_pop200_R6_g0.15_10_loglik.csv", row.names = FALSE)

# Infectious curve data
write.csv(data.frame(inf_data2), file = "mcmc_pop200_R6_g0.15_10_infectious.csv", row.names = FALSE)
