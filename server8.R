...
write.csv(data.frame(beta_gamma_loglik), file = "mcmc_pop200_b0.005_g0.08_2_loglik.csv", row.names = FALSE)

# Infectious curve data
write.csv(data.frame(inf_data2), file = "mcmc_pop200_b0.005_g0.08_2_infectious.csv", row.names = FALSE)
