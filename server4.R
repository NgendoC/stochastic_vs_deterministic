...
run_stoch <- read.csv("data_pop50_R1.5_g0.15_43.csv")
...
write.csv(data.frame(beta_gamma_loglik), file = "mcmc_pop50_1.5_g0.15_43_loglik.csv", row.names = FALSE)

# Infectious curve data
write.csv(data.frame(inf_data2), file = "mcmc_pop50_R1.5_g0.15_43_infectious.csv", row.names = FALSE)
