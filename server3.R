...
run_stoch <- read.csv("data_pop50_b0.05_g0.08_7.csv")
...
write.csv(data.frame(beta_gamma_loglik), file = "mcmc_pop50_b0.05_g0.08_7_loglik.csv", row.names = FALSE)

# Infectious curve data
write.csv(data.frame(inf_data2), file = "mcmc_pop50_b0.05_g0.08_7_infectious.csv", row.names = FALSE)
