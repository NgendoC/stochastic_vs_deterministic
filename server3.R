...
run_stoch <- read.csv("data_pop50_b0.15_g0.1_13.csv")
...
write.csv(data.frame(beta_gamma_loglik), file = "mcmc_pop50_b0.15_g0.1_13_loglik.csv", row.names = FALSE)

# Infectious curve data
write.csv(data.frame(inf_data2), file = "mcmc_pop50_b0.15_g0.1_13_infectious.csv", row.names = FALSE)
