...
write.csv(data.frame(beta_gamma_loglik), file = "mcmc_pop1000_R1.5_g0.15_177_loglik_long.csv", row.names = FALSE)

# Infectious curve data
write.csv(data.frame(inf_data2), file = "mcmc_pop1000_R1.5_g0.15_177_infectious_long.csv", row.names = FALSE)
