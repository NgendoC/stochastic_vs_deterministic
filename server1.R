...
run_stoch <- read.csv("data_pop50_b2e-2_g7e-2_1.csv")
...
write.csv(data.frame(beta_gamma_loglik), file = "mcmc_pop50_b2e-2_g7e-2_1_loglik.csv", row.names = FALSE)

# Infectious curve data
write.csv(data.frame(inf_data2), file = "mcmc_pop50_b2e-2_g7e-2_1_infectious.csv", row.names = FALSE)
