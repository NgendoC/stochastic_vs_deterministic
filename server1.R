...
run_stoch <- read.csv("data_pop50_b0.005_g0.08_35.csv")
...
write.csv(data.frame(beta_gamma_loglik), file = "mcmc_pop100k_b0.005_g0.08_35_loglik.csv", row.names = FALSE)

# Infectious curve data
write.csv(data.frame(inf_data2), file = "mcmc_pop100k_b0.005_g0.08_35_infectious.csv", row.names = FALSE)
