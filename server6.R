...
run_stoch <- read.csv("data_pop200_R1.5_g0.15_202.csv")
...
write.csv(data.frame(beta_gamma_loglik), file = "mcmc_pop200_1.5_g0.15_202_loglik.csv", row.names = FALSE)

# Infectious curve data
write.csv(data.frame(inf_data2), file = "mcmc_pop200_R1.5_g0.15_202_infectious.csv", row.names = FALSE)
