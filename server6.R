...
run_stoch <- read.csv("data_pop200_b0.15_g0.1_18.csv")
...
write.csv(data.frame(beta_gamma_loglik), file = "mcmc_pop200_b0.15_g0.1_18_loglik.csv", row.names = FALSE)

# Infectious curve data
write.csv(data.frame(inf_data2), file = "mcmc_pop200_b0.15_g0.1_18_infectious.csv", row.names = FALSE)
