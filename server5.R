...
run_stoch <- read.csv("data_pop100_b0.005_g0.08_37.csv")
...
write.csv(data.frame(beta_gamma_loglik), file = "mcmc_data_pop100_b0.005_g0.08_37_loglik.csv", row.names = FALSE)

# Infectious curve data
write.csv(data.frame(inf_data2), file = "mcmc_pop100_b0.005_g0.08_37_infectious.csv", row.names = FALSE)
